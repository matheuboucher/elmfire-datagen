...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=25.4 # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=113.4  # Wind direction, deg
...
INT_RASTER[2]=asp     ; INT_VAL[2]=137   # Topographical aspect (deg) # perturbed directly
...
LH_MOISTURE_CONTENT=120.0 # Live herbaceous moisture content, percent
LW_MOISTURE_CONTENT=150.0 # Live woody moisture content, percent
