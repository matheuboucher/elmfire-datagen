...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=25.8 # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=286.5  # Wind direction, deg
FLOAT_RASTER[3]=m1   ; FLOAT_VAL[3]=6.0  # 1-hr   dead moisture content, %
FLOAT_RASTER[4]=m10  ; FLOAT_VAL[4]=7.0  # 10-hr  dead moisture content, %
FLOAT_RASTER[5]=m100 ; FLOAT_VAL[5]=8.0  # 100-hr dead moisture content, %
...
NUM_INT_RASTERS=8
INT_RASTER[1]=slp     ; INT_VAL[1]=24   # Topographical slope (deg) # perturbed directly
INT_RASTER[2]=asp     ; INT_VAL[2]=341   # Topographical aspect (deg) # perturbed directly
