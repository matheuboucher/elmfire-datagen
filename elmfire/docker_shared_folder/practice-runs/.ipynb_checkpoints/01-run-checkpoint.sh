...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=6.3 # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=98.3  # Wind direction, deg
FLOAT_RASTER[3]=m1   ; FLOAT_VAL[3]=12.0  # 1-hr   dead moisture content, %
FLOAT_RASTER[4]=m10  ; FLOAT_VAL[4]=13.0  # 10-hr  dead moisture content, %
FLOAT_RASTER[5]=m100 ; FLOAT_VAL[5]=14.0  # 100-hr dead moisture content, %
...
NUM_INT_RASTERS=8
INT_RASTER[1]=slp     ; INT_VAL[1]=3   # Topographical slope (deg) # perturbed directly
INT_RASTER[2]=asp     ; INT_VAL[2]=207   # Topographical aspect (deg) # perturbed directly
INT_RASTER[3]=dem     ; INT_VAL[3]=0   # Elevation (m)
INT_RASTER[4]=fbfm40  ; INT_VAL[4]=101 # Fire behavior fuel model code (-)
...
LH_MOISTURE_CONTENT=90.0 # Live herbaceous moisture content, percent
LW_MOISTURE_CONTENT=120.0 # Live woody moisture content, percent
...
# echo -n > ../fire_area_most_recent_run.txt
