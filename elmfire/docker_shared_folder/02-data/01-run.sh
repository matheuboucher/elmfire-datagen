...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=3.4 # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=204.6  # Wind direction, deg
...
INT_RASTER[2]=asp     ; INT_VAL[2]=300   # Topographical aspect (deg) # perturbed directly
INT_RASTER[3]=dem     ; INT_VAL[3]=0   # Elevation (m)
INT_RASTER[4]=fbfm40  ; INT_VAL[4]=124 # Fire behavior fuel model code (-)
